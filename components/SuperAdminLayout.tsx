        ...
        return (
            <button
                ...
                className={`w-full flex items-center gap-3 px-3.5 py-3 text-sm font-semibold rounded-2xl transition-all duration-300 mb-1
                    ${isActive
                        ? 'bg-ministral-500 text-white shadow-lg shadow-ministral-500/30'
                        : 'text-slate-500 dark:text-slate-400 hover:bg-ministral-50 dark:hover:bg-ministral-900/10 hover:text-ministral-500 dark:hover:text-ministral-400'
                    }`}
            >
                ...
                {item.badge && (
                    <span className="bg-ministral-100 dark:bg-ministral-900/40 text-ministral-500 dark:text-ministral-300 text-[10px] font-black px-2 py-0.5 rounded-full">
                        {item.badge}
                    </span>
                )}
        ...
        <div className="flex h-screen overflow-hidden bg-slate-50 dark:bg-ministral-dark font-sans">
            ...
            `}>
                ...
                <div className="py-8 px-6 shrink-0">
                    <div className="flex items-center gap-4">
                        ...
                        <div className="flex-1 min-w-0">
                            ...
                            <span className="inline-flex items-center gap-1 text-[10px] font-black uppercase tracking-widest text-ministral-gold dark:text-ministral-gold">
                ...
                <div className="flex-1 overflow-y-auto py-2 px-4 custom-scrollbar">
                    <div>
                        <p className="px-3 text-[10px] font-black text-ministral-500 tracking-[0.2em] mb-4 uppercase">
                            Gestão Global
                        </p>
                ...
                <div className="m-4 p-4 rounded-[2rem] border-t border-slate-200/50 dark:border-slate-800/50 bg-slate-50/50 dark:bg-slate-900/30 backdrop-blur-md">
                    <div className="flex items-center gap-3 p-2 rounded-2xl mb-3">
                        <div className="w-10 h-10 flex-shrink-0 rounded-full bg-ministral-500 flex items-center justify-center text-white font-black text-sm border-2 border-white dark:border-ministral-dark shadow-md">
                        ...
                        <div className="flex-1 min-w-0 text-left">
                            ...
                            <p className="text-[10px] text-ministral-gold dark:text-ministral-gold font-bold flex items-center gap-1">
            ...
            <main className="flex-1 flex flex-col min-w-0 max-w-full bg-transparent overflow-hidden relative">
                ...
                <header className="lg:hidden h-16 px-4 flex items-center justify-between sticky top-0 z-30 bg-white/70 dark:bg-ministral-dark/70 backdrop-blur-2xl border-b border-slate-200/50 dark:border-slate-800/50">
                    <div className="flex items-center gap-3">
                        ...
                        <div className="flex items-center gap-2">
                            <Shield size={16} className="text-ministral-500" />
                    ...
                    <div className="flex items-center gap-2">
                        <div className="w-9 h-9 rounded-full bg-ministral-500 flex items-center justify-center text-white font-black text-xs">
                            {currentUser?.name?.charAt(0)?.toUpperCase() ?? 'S'}
                        </div>
                    </div>
                </header>
                ...
                <header className="hidden lg:flex h-20 px-10 items-center justify-between sticky top-0 z-30 bg-slate-50/50 dark:bg-ministral-dark/50 backdrop-blur-xl border-b border-slate-200/50 dark:border-slate-800/50">
                    <div className="flex items-center gap-4">
                        <div className="text-ministral-500 p-2.5 bg-ministral-50 dark:bg-ministral-900/20 rounded-2xl shadow-sm border border-ministral-200 dark:border-ministral-900/40">
                            <Shield size={20} />
                        </div>
